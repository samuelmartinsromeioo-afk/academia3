...
class TestSeeder extends Seeder
{
    ...
    {
        // ✅ Personal padrão para teste
       Personal::firstOrCreate(['email' => 'personal@teste.com'],[
            'nome'        => 'Personal Teste',
            ...
            'latitude'    => -19.9200,  // ✅ adicione
            'longitude'   => -43.9400,  // ✅ adicione
        ]);

        // ✅ Cliente padrão para teste
        Cliente::firstOrCreate(['email' => 'cliente@teste.com'], [
            'nome'               => 'Cliente Teste',
