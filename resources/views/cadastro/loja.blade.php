...
<div class="auth-card">
    ...
    <form action="{{ route('loja.store') }}" method="POST" class="form-grid">
        ...
        <label class="full-width" style="display:flex; align-items:flex-start; gap:10px; color:#cfd3da; font-size:0.88rem; margin:6px 0 4px; line-height:1.5;">
            ...
            <span>Declaro ter poderes para representar a loja e li e concordo com os
                <a href="{{ route('termos.loja') }}" target="_blank" style="color:#d4ff00;">Termos de Uso da Loja</a>
