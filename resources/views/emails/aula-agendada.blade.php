...
<head>
    ...
    <style>
        ...
        .logo { font-size: 1.6rem; font-weight: 900; letter-spacing: 4px; color: #7cff00; text-transform: uppercase; }
        .badge { display: inline-block; background: rgba(124,255,0,0.15); color: #7cff00; font-size: 0.8rem; padding: 4px 12px; border-radius: 20px; margin-top: 10px; }
        ...
        .info-box { background: #f8f9fa; border-left: 4px solid #7cff00; border-radius: 8px; padding: 16px 20px; margin: 20px 0; }
