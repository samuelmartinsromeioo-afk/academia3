...
<body class="ed-page">
    ...
    <script>
        ...
        function renderChart() {
            ...
            const data = { labels: dadosMedidas.labels, datasets:[{ label:dadosMedidas.rotulos[campo], data:dadosMedidas.campos[campo], borderColor:'#7cff00', backgroundColor:g, borderWidth:3, pointBackgroundColor:'#7cff00', pointRadius:4, tension:0.3, fill:true, spanGaps:true }] };
