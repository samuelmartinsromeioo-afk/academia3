...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .rec .ico { width:34px; height:34px; border-radius:9px; background:rgba(124, 255, 0,0.14); color:var(--primary); display:flex; align-items:center; justify-content:center; }
